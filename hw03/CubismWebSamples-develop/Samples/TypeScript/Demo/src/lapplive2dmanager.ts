...
export class LAppLive2DManager {
  ...
  public onUpdate(): void {
    ...
    for (let i = 0; i < modelCount; ++i) {
      ...
      //spec
      model.tere = this.tere;
      model.faceForm = this.faceForm;
      model.eyeForm = this.eyeForm;
      model.tear = this.tear;
      model.scarf = this.scarf;
      model.bodyUpper = this.bodyUpper;
      model.handChangeR = this.handChangeR;
      model.handAngleR = this.handAngleR;
      model.handDhangeL = this.handDhangeL;
      model.handAngleL = this.handAngleL;
