 ...
 */
 ...
 export class LAppModel extends CubismUserModel {
   ...
   public update(): void {
     ...
     //spec
     this._model.setParameterValueById(this._idParamTere, this.tere);
     this._model.setParameterValueById(this._idParamFaceForm, this.faceForm);
     this._model.setParameterValueById(this._idParamEyeForm, this.eyeForm);
     this._model.setParameterValueById(this._idParamTear, this.tear);
     this._model.setParameterValueById(this._idParamScarf, this.scarf);
     this._model.setParameterValueById(this._idParamBodyUpper, this.bodyUpper);
     this._model.setParameterValueById(this._idParamHandChangeR, this.handChangeR);
     this._model.setParameterValueById(this._idParamHandAngleR, this.handAngleR);
     this._model.setParameterValueById(this._idParamHandDhangeL, this.handDhangeL);
     this._model.setParameterValueById(this._idParamHandAngleL, this.handAngleL);
   ...
   public constructor() {
     ...
     //spec
     this._idParamTere = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamTere
     );
     this._idParamFaceForm = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamFaceForm
     );
     this._idParamEyeForm = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamEyeForm
     );
     this._idParamTear = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamTear
     );
     this._idParamScarf = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamScarf
     );
     this._idParamBodyUpper = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBodyUpper
     );
     this._idParamHandChangeR = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHandChangeR
     );
     this._idParamHandAngleR = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHandAngleR
     );
     this._idParamHandDhangeL = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHandDhangeL
     );
     this._idParamHandAngleL = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHandAngleL
     );
   ...
   //spec
   _idParamTere: CubismIdHandle;
   _idParamFaceForm: CubismIdHandle;
   _idParamEyeForm: CubismIdHandle;
   _idParamTear: CubismIdHandle;
   _idParamScarf: CubismIdHandle;
   _idParamBodyUpper: CubismIdHandle;
   _idParamHandChangeR: CubismIdHandle;
   _idParamHandAngleR: CubismIdHandle;
   _idParamHandDhangeL: CubismIdHandle;
   _idParamHandAngleL: CubismIdHandle;
   //HW03 綁定參數 end
   ...
   public isTouchBody: boolean = false;

   //spec
   public tere:number=0;
   public faceForm:number=0;
   public eyeForm:number=0;
   public tear:number=0;
   public scarf:number=0;
   public bodyUpper:number=0;
   public handChangeR:number=0;
   public handAngleR:number=0;
   public handDhangeL:number=0;
   public handAngleL:number=0;
