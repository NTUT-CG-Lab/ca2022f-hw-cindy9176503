...
export class LAppView {
  ...
  public render(): void {
    ...
    //spec
    live2DManager.tere = this.tere;
    live2DManager.faceForm = this.faceForm;
    live2DManager.eyeForm = this.eyeForm;
    live2DManager.tear = this.tear;
    live2DManager.scarf = this.scarf;
    live2DManager.bodyUpper = this.bodyUpper;
    live2DManager.handChangeR = this.handChangeR;
    live2DManager.handDhangeL = this.handDhangeL;
    live2DManager.handAngleL = this.handAngleL;
  ...
  public initializeSprite(): void {
    ...
    const initBackGroundTexture = (textureInfo: TextureInfo): void => {
      ...
      const fwidth = textureInfo.width * 4.0; //2.0
      const fheight = height * 1; //0.95
  ...
  public eyeLOpen:number = 30;
  public eyeLSmile:number = 0;
  public eyeROpen:number = 30;
  ...
  //mouth form
  public mouthForm: number = 1;
  //mouth openY
  public mouthOpenY: number = 1;
